...
export async function sendAirportEnquiry(data) {
  ...
  return transporter.sendMail({
    from: `"TaxiTribe Airport" <${process.env.SMTP_USER}>`,
    to: process.env.MAIL_TO,
    subject: "🚖 New Airport Taxi Enquiry",
    html: `
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;margin:auto;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr>
        <td style="padding:25px;color:#333;">
          <p style="font-size:15px;margin-bottom:20px;">
            You have received a new airport taxi enquiry. Details are below:
          </p>
          ...
          <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;font-size:14px;">
            ...
            <tr style="background:#f8f8f8;">
              <td style="font-weight:600;">Travel City</td>
              <td>${data.city || "-"}</td>
            </tr>
          ...
          <p style="margin-top:25px;font-size:14px;color:#555;">
            Please contact the customer immediately to confirm pricing and availability.
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="background:#f0f0f0;padding:15px;text-align:center;font-size:12px;color:#777;">
          © ${new Date().getFullYear()} TaxiTribe • Airport Transfer Services  
          <br/>
