    ...
    <div className="bg-[#F9FAFB] min-h-screen">
      ...
      <section className="relative w-full bg-slate-900 text-white pt-10">
        <div className="absolute inset-0">
          {/* yaha apni Delhi hero image laga dena */}
          <div className="w-full h-full bg-[url('/taxitribe-delhi-hero.webp')] bg-cover bg-center opacity-40" />
        </div>
        ...
        <div className="relative container mx-auto px-4 py-10 lg:py-14">
          <div className="max-w-3xl bg-black/30 backdrop-blur-sm rounded-2xl p-4 md:p-5">
            ...
            <p className="mt-3 text-sm md:text-base text-gray-100 max-w-xl">
              Airport transfers, outstation trips, and local rides across{" "}
              {city} & NCR. Professional drivers, clean cars and transparent
          ...
          <div className="space-y-10 text-sm md:text-base leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3 text-gray-700">
                TaxiTribe brings you a full range of taxi options in {city}. From
                daily office commute and metro connectivity drops to airport
                transfers and weekend outstation trips – sab kuch ek hi platform
                se manage ho jata hai.
              </p>
                ...
                {[
                  {
                    ...
                    desc: `Point-to-point rides within ${city} for office, shopping and daily work.`,
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: "One-way or round-trip cabs to nearby cities & hill stations like Jaipur, Agra, Manali, etc.",
                  },
                  {
                    title: "Corporate & Event Travel",
                    desc: "Dedicated cabs for offices, conferences, weddings and VIP guest movements.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
            ...
            <section>
              ...
              <ul className="mt-3 space-y-2 text-gray-700 list-disc list-inside">
                <li>Verified, polite drivers with strong Delhi route knowledge.</li>
                <li>
                  Transparent pricing – no hidden charges or last-minute surprises.
                </li>
                <li>
                  Clean, well-maintained cars with regular hygiene checks.
                </li>
                <li>
                  24×7 customer support for booking and trip assistance.
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-gray-900">
                Delhi Office – TaxiTribe
              </h2>
              <p className="mt-3 text-gray-700">
                Our Delhi hub manages all corporate, local and outstation trips
                for customers across Delhi–NCR.
              </p>
              <div className="mt-2 space-y-1 text-gray-800 text-sm md:text-base">
                <p>
                  <span className="font-semibold">Address:&nbsp;</span>
                  E-169, East of Kailash, New Delhi 110065
                </p>
                <p>
