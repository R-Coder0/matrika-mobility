    ...
    <div className="bg-[#F9FAFB] min-h-screen">
      ...
      <section className="relative w-full bg-slate-900 text-white pt-10">
        <div className="absolute inset-0">
          <div className="w-full h-full bg-[url('/taxitribe-gurgaon-hero.webp')] bg-cover bg-center opacity-40" />
        </div>
        ...
        <div className="relative container mx-auto px-4 py-10 lg:py-14">
          <div className="max-w-3xl bg-black/30 backdrop-blur-sm rounded-2xl p-4 md:p-5">
            ...
            <p className="mt-3 text-sm md:text-base text-gray-100 max-w-xl">
              Airport transfers, outstation trips, and local rides in {city},{" "}
              {state}. Professional drivers, clean cars and transparent pricing –
          ...
          <div className="space-y-10 text-sm md:text-base leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-3 text-gray-700">
                TaxiTribe brings you a full range of taxi and cab options in{" "}
                {city}. From daily office commute to airport transfers and
                weekend outstation trips – sab kuch ek hi jagah se manage ho
                jata hai.
              </p>
                ...
                {[
                  {
                    ...
                    desc: `Affordable point-to-point rides within ${city} for office, shopping, and daily work.`,
                  },
                  {
                    title: "Airport Transfers",
                    desc: `On-time pickups & drops for Delhi Airport from anywhere in ${city}.`,
                  },
                  {
                    title: "Outstation Cabs",
                    desc: "Hire one-way or round trip cabs to nearby cities and hill stations.",
                  },
                  {
                    title: "Corporate & Event Travel",
                    desc: "Dedicated cabs for offices, weddings, and bulk bookings.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
            ...
            <section>
              ...
              <ul className="mt-3 space-y-2 text-gray-700 list-disc list-inside">
                <li>Verified and polite drivers with local route knowledge.</li>
                <li>
                  Transparent pricing – no hidden charges or last-minute
                  surprises.
                </li>
                <li>
