...
export default function LongTermFixedRentalHyderabad() {
    ...
    return (
        <section className="bg-[#FFFFFF] text-gray-900">
            {/* ================= SEO ================= */}
            <Helmet>
                <title>Long-Term Fixed Car Rentals in Hyderabad | TaxiTribe</title>
                <meta
                    name="description"
                    content="TaxiTribe offers long-term fixed car rentals in Hyderabad with dedicated vehicles, trained chauffeurs, fixed monthly pricing and 24x7 corporate support."
                />
                <link
                    rel="canonical"
                    href="https://taxitribe.in/long-term-fixed-rental-hyderabad"
                />
            </Helmet>
            ...
            <div className="relative min-h-[70vh] pt-28 md:pt-14 pb-24 md:pb-14 flex items-center">
                <img
                    ...
                    alt="Long-Term Fixed Car Rentals in Hyderabad"
                ...
                <div className="relative z-10 container mx-auto px-6">
                    ...
                    <p className="mt-6 text-lg text-gray-200 max-w-3xl">
                        ...
                        for Hyderabad’s IT, pharma and enterprise ecosystem.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold mb-6">
                            Long-Term Fixed Rentals in Hyderabad – Designed for Scalable Enterprises
                        </h2>

                        <p className="text-gray-700 mb-4 leading-relaxed">
                            Hyderabad is a fast-growing hub for IT, pharmaceuticals,
                            and global enterprises where predictable, reliable
                            transportation is essential. TaxiTribe’s long-term
                            fixed rental services in Hyderabad are built for
                            organizations that need dedicated vehicles on
                            monthly contracts.
                        </p>

                        <p className="text-gray-700 mb-4 leading-relaxed">
                            With fixed monthly commercials, assigned chauffeurs,
                            and standby vehicles, we eliminate operational
                            uncertainty and ensure seamless executive and
                            employee mobility.
                        </p>

                        <p className="text-gray-700 leading-relaxed">
                            Ideal for IT parks, pharma companies, GCCs, BPOs,
                            and CXO travel — TaxiTribe delivers SLA-driven
                            performance across Hyderabad and surrounding regions.
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl overflow-hidden shadow-sm">
                        <img
                            src="/2.jpeg"
                            alt="Corporate long term car rental Hyderabad"
            ...
            <div className="bg-white border-t border-b border-gray-100">
                <div className="container mx-auto px-6 py-20">
                    <h2 className="text-3xl font-bold text-center mb-6">
                        Why Choose TaxiTribe for Fixed Rentals in Hyderabad?
                    </h2>
                    ...
                    <p className="text-gray-700 text-center max-w-3xl mx-auto mb-12 leading-relaxed">
                        ...
                        Hyderabad’s expanding corporate ecosystem.
                    </p>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            {
                                icon: <FaShieldAlt />,
                                text: "SLA-backed operations with backup vehicles",
                            },
                            {
                                icon: <FaHeadset />,
                                text: "Dedicated account manager with 24×7 support",
                            },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
            ...
            <div className="container mx-auto px-6 pb-24">
                <div className="bg-amber-600/10 border border-amber-200 rounded-2xl p-12 text-center">
                    <h2 className="text-3xl font-bold mb-4">
                        Looking for a Long-Term Rental Partner in Hyderabad?
                    </h2>
            ...
            <BookingDialog
                open={dialogOpen}
                model="Long-Term Fixed Rental – Hyderabad"
