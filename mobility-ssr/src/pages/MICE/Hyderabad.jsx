...
export default function MICEHyderabad() {
    ...
    return (
        <section className="bg-[#FFFFFF] text-gray-900">
            {/* ================= SEO ================= */}
            <Helmet>
                <title>MICE Transport Services in Hyderabad | Corporate Event Mobility | TaxiTribe</title>
                <meta
                    name="description"
                    content="TaxiTribe provides professional MICE transport services in Hyderabad for meetings, conferences, exhibitions and corporate events with dedicated fleets and on-ground coordination."
                />
                <link
                    rel="canonical"
                    href="https://taxitribe.in/mice-in-hyderabad"
                />
            </Helmet>
            ...
            <div className="relative min-h-[70vh] pt-28 md:pt-14 pb-24 md:pb-14 flex items-center">
                <img
                    ...
                    alt="MICE Transport Services in Hyderabad"
                ...
                <div className="relative z-10 container mx-auto px-6">
                    ...
                    <p className="mt-6 text-lg text-gray-200 max-w-3xl">
                        ...
                        conferences and corporate events across Hyderabad.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold mb-6">
                            Corporate MICE Transportation in Hyderabad – Reliable & Well-Coordinated
                        </h2>

                        <p className="text-gray-700 mb-4 leading-relaxed">
                            Hyderabad is a rapidly growing hub for IT, pharmaceuticals,
                            global conferences and corporate events. TaxiTribe offers
                            specialized MICE transportation services in Hyderabad
                            designed to manage complex event logistics with accuracy
                            and efficiency.
                        </p>

                        <p className="text-gray-700 mb-4 leading-relaxed">
                            From airport transfers for delegates to multi-day shuttles,
                            VIP movements and multi-venue coordination, our operations
                            team ensures smooth execution throughout the event lifecycle.
                        </p>

                        <p className="text-gray-700 leading-relaxed">
                            Trusted by corporates, event agencies and hospitality partners,
                            TaxiTribe delivers punctual, secure and brand-aligned
                            transportation across Hyderabad and nearby business corridors.
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl overflow-hidden shadow-sm">
                        <img
                            src="/2.jpeg"
                            alt="Corporate event transport Hyderabad"
            ...
            <div className="bg-white border-t border-b border-gray-100">
                <div className="container mx-auto px-6 py-20">
                    <h2 className="text-3xl font-bold text-center mb-6">
                        Why Choose TaxiTribe for MICE in Hyderabad?
                    </h2>

                    <p className="text-gray-700 text-center max-w-3xl mx-auto mb-12 leading-relaxed">
                        MICE transportation requires precise planning, disciplined execution
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            {
                                icon: <FaCalendarAlt />,
                                text: "Pre-event planning with routes & timelines",
                            },
                            {
                                icon: <FaUsers />,
                            ...
                            {
                                icon: <FaShieldAlt />,
                                text: "Trained chauffeurs with strict safety protocols",
                            },
                            {
                                icon: <FaHeadset />,
            ...
            <div className="container mx-auto px-6 py-20">
                ...
                <p className="text-gray-700 text-center max-w-3xl mx-auto mb-12">
                    A structured framework to ensure smooth event-day mobility.
                </p>
                ...
                <div className="grid md:grid-cols-4 gap-8">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: "Fleet allocation, routing and schedules finalized.",
                        },
                        {
                            title: "Live Event Execution",
                            desc: "On-ground coordination with chauffeurs & planners.",
                        },
                        {
                            title: "Post-Event Closure",
                            desc: "Reporting, billing and performance review.",
                        },
                    ].map((step, i) => (
                        <div
                            key={i}
            ...
            <div className="container mx-auto px-6 pb-24">
                <div className="bg-amber-600/10 border border-amber-200 rounded-2xl p-12 text-center">
                    <h2 className="text-3xl font-bold mb-4">
                        Planning a Corporate Event in Hyderabad?
                    </h2>
                    <p className="text-gray-700 mb-8">
                        Let TaxiTribe manage your MICE transportation with precision.
                    </p>
                    <button
                        onClick={() => setDialogOpen(true)}
            ...
            <BookingDialog
                open={dialogOpen}
                model="MICE Transport Service – Hyderabad"
