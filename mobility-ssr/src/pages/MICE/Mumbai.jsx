...
export default function MICEMumbai() {
    ...
    return (
        <section className="bg-[#FFFFFF] text-gray-900">
            {/* ================= SEO ================= */}
            <Helmet>
                <title>MICE Transport Services in Mumbai | Corporate Event Mobility | TaxiTribe</title>
                <meta
                    name="description"
                    content="TaxiTribe delivers professional MICE transport services in Mumbai for meetings, conferences, exhibitions and corporate events with dedicated fleets and on-ground coordination."
                />
                <link
                    rel="canonical"
                    href="https://taxitribe.in/mice-in-mumbai"
                />
            </Helmet>
            ...
            <div className="relative min-h-[70vh] pt-28 md:pt-14 pb-24 md:pb-14 flex items-center">
                <img
                    ...
                    alt="MICE Transport Services in Mumbai"
                ...
                <div className="relative z-10 container mx-auto px-6">
                    ...
                    <p className="mt-6 text-lg text-gray-200 max-w-3xl">
                        ...
                        conferences, exhibitions and corporate events across Mumbai & MMR.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold mb-6">
                            Corporate MICE Transportation in Mumbai – Precision at Scale
                        </h2>

                        <p className="text-gray-700 mb-4 leading-relaxed">
                            Mumbai is India’s financial and commercial capital, hosting
                            large-scale conferences, exhibitions, product launches
                            and leadership summits year-round. TaxiTribe offers
                            specialized MICE transportation services in Mumbai
                            designed to manage high-volume, high-stakes event logistics.
                        </p>

                        <p className="text-gray-700 mb-4 leading-relaxed">
                            From airport transfers for delegates and VIP convoys
                            to multi-venue shuttles and event-day coordination,
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            ...
                            transportation across Mumbai and the MMR region.
                        </p>
                    </div>
                    ...
                    <div className="rounded-2xl overflow-hidden shadow-sm">
                        <img
                            src="/2.jpeg"
                            alt="Corporate event transport Mumbai"
            ...
            <div className="bg-white border-t border-b border-gray-100">
                <div className="container mx-auto px-6 py-20">
                    <h2 className="text-3xl font-bold text-center mb-6">
                        Why Choose TaxiTribe for MICE in Mumbai?
                    </h2>

                    <p className="text-gray-700 text-center max-w-3xl mx-auto mb-12 leading-relaxed">
                        MICE transportation in Mumbai demands meticulous planning,
                        real-time coordination and absolute reliability.
                    </p>
            ...
            <div className="container mx-auto px-6 py-20">
                ...
                <p className="text-gray-700 text-center max-w-3xl mx-auto mb-12">
                    A structured framework to ensure flawless event mobility.
                </p>
                ...
                <div className="grid md:grid-cols-4 gap-8">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: "Fleet planning, routing and time schedules finalized.",
                        },
                        {
            ...
            <div className="container mx-auto px-6 pb-24">
                <div className="bg-amber-600/10 border border-amber-200 rounded-2xl p-12 text-center">
                    <h2 className="text-3xl font-bold mb-4">
                        Planning a Corporate Event in Mumbai?
                    </h2>
            ...
            <BookingDialog
                open={dialogOpen}
                model="MICE Transport Service – Mumbai"
