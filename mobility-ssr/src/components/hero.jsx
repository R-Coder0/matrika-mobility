...
export default function Hero() {
  ...
  return (
    <>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="mb-8 flex flex-wrap items-center gap-x-6 gap-y-3 text-gray-300">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Uncompromising women-focused safety protocols backed by live
                  tracking, SOS systems, and 24×7 oversight
                </span>
              </div>
              <div className="flex items-center gap-2">
      ...
      <section className="lg:hidden bg-gray-50 py-8 md:py-6">
        <div className="max-w-7xl mx-auto px-2">
          {/* <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              Get Your <span className="text-amber-500">Custom Quote</span> Now
            </h2>
            <p className="text-gray-600">
              Fill in your details and our team will contact you within 15 minutes 
              with the best corporate car rental solutions.
            </p>
          </div> */}
