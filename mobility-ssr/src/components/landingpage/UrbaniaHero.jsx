...
import { Phone, ArrowRight, Star, ShieldCheck, Users, PhoneCallIcon } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <span className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 text-sm font-semibold rounded-full bg-blue-50 text-blue-600">
              ...
              Luxury Urbania Rentals • PAN India
            </span>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-700">
              <div className="flex items-center gap-2">
                <Users className="w-4 h-4 text-[#fe9a00]" />
                9, 12 & 17 Seater Options
              </div>
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-[#fe9a00]" />
                Verified Drivers & Luxury Interiors
              </div>
            </div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-5">
              ...
              {/* Quote CTA */}
              <a
                href="mailto:sales@taxitribe.in?subject=Urbania%20Booking%20Enquiry"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl
            ...
            <p className="mt-4 text-xs text-gray-400">
              All India Permit • Ideal for Weddings • Corporate & Family Trips
            </p>
          ...
          <div className="relative">
            ...
            <img
              src="/urbania.avif"
              alt="Urbania Tempo Traveller Service"
            ...
            <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl shadow-xl p-5 flex items-center gap-4 border">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Successful Urbania Bookings</p>
              </div>
            </div>
